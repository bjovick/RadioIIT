...
if (strpos($_SERVER['HTTP_HOST'], '11117.a.hostable.me') !== false
	 || strpos($_SERVER['HTTP_HOST'], 'radioiit.co.cc') !== false) {
 ...
 */
Route::set('default', '(<controller>(/<action>(/<mas>)))', array('mas'=>'.*'))
	->defaults(array(
		'controller' => 'inicio',
		'action'     => 'index',
	));
...
if (Kohana::$environment == Kohana::PRODUCTION) {
	set_exception_handler(array(new ReguladorErrores(),'gestionar'));
}
